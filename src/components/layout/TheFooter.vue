<template>
  <footer class="bg-dark-800 border-t border-white/5 py-5">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div class="flex items-center gap-4">
          <a
            ...
            class="w-10 h-10 rounded-xl glass-card flex items-center justify-center text-gray-400 hover:text-primary-400 hover:border-primary-500/30 transition-all duration-300 hover:-translate-y-0.5"
        ...
        <!-- Copyright -->
        <p class="text-gray-500 text-sm font-body  text-center">
          © {{ currentYear }} ENCODEX<br>Todos los derechos reservados.
        </p>
      </div>
      ...
      <div v-if="props.isNav" class="flex flex-wrap justify-center gap-x-8 gap-y-2 mt-4 pt-4 border-t border-white/5">
        <a
          ...
          :key="link.href"
          :href="link.href"
          class="text-gray-500 hover:text-gray-300 text-sm font-body transition-colors"
        >
          {{ link.label }}
        </a>
      </div>
...
const WhatsAppIcon = () => h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
...
const socialLinks = [
  ...
  { label: 'WhatsApp', href: 'https://api.whatsapp.com/send?phone=56208608000&text=Hola, me gustaría obtener más información sobre sus servicios.', icon: WhatsAppIcon },
]
